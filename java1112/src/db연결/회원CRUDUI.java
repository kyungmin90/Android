...
public class 회원CRUDUI {
	...
	public static void main(String[] args) {
		...
		JLabel loginlabel = new JLabel("로그인 버튼을 눌러주세요.");
		loginlabel.setHorizontalAlignment(SwingConstants.CENTER);
		loginlabel.setFont(new Font("굴림", Font.BOLD, 14));
		loginlabel.setBounds(149, 309, 222, 28);
		...
		login.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(login) {
					loginlabel.setText("Login 성공");
				}else {
					loginlabel.setText("Login 실패");
				}
				} catch (Exception e1) {
					e1.printStackTrace();
				}
		...
		read_1.setBackground(SystemColor.menu);
		read_1.setBounds(149, 391, 97, 23);
